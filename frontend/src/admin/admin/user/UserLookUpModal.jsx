                                ...
                                {props.userLookUp.map((user, index) => (
                                    <div key={index}>
                                        {(props.modalForFather && user.gender === "MALE") || (props.modalForMother && user.gender === "FEMALE") ? (
                                            ...
                                            <div className={`border-bottom px-5 py-4 lookup-modal ${(props.selectedFather && props.selectedFather.name === user.name) || (props.selectedMother && props.selectedMother.name === user.name )? 'active' : ''}`} data-bs-dismiss="modal"  onClick={() => {
