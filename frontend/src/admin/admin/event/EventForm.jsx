                ...
                .then((response) => {
                    if (response.data.status === 1) {
                        ...
                        seteventForm({
                            ...
                            activityCategory: event.activityCategory ? event.activityCategory : "",
                        })
            ...
            <div className="card content-main">
                ...
                <div className="card-body content-body create-form-page">
                    ...
                    <form className="row mt-5 gx-5 gy-5" onSubmit={handleSubmitForm}>
                        ...
                        <div className="col-md-6">
                            <label htmlFor="eventInputeventOn">
                                Event Date
                            </label>
                            <i className="text-danger">*</i>
                            <input
                        ...
                        <div className="col-md-6">
                            ...
                            <div className="form-check h-100 d-flex align-items-center">
                                <input className="form-check-input" type="checkbox" name="isActivity" id="eventInputIsCategory" value={isActivity} onChange={() => {
                                    seteventForm({
                                        ...eventForm,
                                ...
                                <label className="form-check-label" htmlFor="eventInputIsCategory">
                                    Is Activity?
                                </label>
                            </div>
                        </div>
                        ...
                        <div className='col-md-12'>
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    required={eventId}
                                    value={eventForm.mainImageURL ? eventForm.mainImageURL : ''}
